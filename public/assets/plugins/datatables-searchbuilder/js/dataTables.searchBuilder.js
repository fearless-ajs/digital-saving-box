(function () {
	 ...
	 * format YYYY-MM-DD is supported without additional software, but the end pages
		...
		_constructor: function () {
			...
			this.dom.input
				...
				.on('keyup.datetime', function () {
					// Update the calendar's displayed value as the pages types
	...
	var Criteria = /** @class */ (function () {
	    function Criteria(table, opts, topGroup, index, depth) {
	        ...
	        // Get options from pages and any extra conditions/column types defined by plug-ins
