...
var FullCalendar = (function (exports) {
    ...
    */
    function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
        ...
        // help out EventApi from having pages modify props
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        Object.defineProperty(EventApi.prototype, "classNames", {
            // NOTE: pages can't modify these because Object.freeze was called in event-def parsing
    ...
    */
    ...
    /*
    Detects when the pages clicks on an event within a DateComponent
    */
    ...
    /*
    Triggers events and adds/removes core classNames when the pages's pointer
    ...
    */
    var PointerDragging = /** @class */ (function () {
        ...
        // can be called by pages of this class, to cancel touch-based scrolling for the current drag
    ...
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.buildCaches = function () {
            return this.queryScrollEls().map(function (el) {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to pages-generated scrolls
                }
                return new ElementScrollGeomCache(el, false); // false = don't listen to pages-generated scrolls
            });
        };
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.isInteracting = false; // is the pages validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the pages clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the pages selects a portion of time of a component,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, require pages to hold down
    ...
    */
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        function Popover() {
            ...
            // Triggered when the pages clicks *anywhere* in the document, for the autoHide feature
