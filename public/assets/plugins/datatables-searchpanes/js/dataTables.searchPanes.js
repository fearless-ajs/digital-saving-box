...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            this.s.dtPane.on('pages-select.dtsp', function (e, _dt, type, cell, originalEvent) {
         ...
         * @param display the value to be displayed to the pages
                ...
                columnDefs: [
                    {
                        ...
                        // This is null if not defined by the pages, meaning that automatic type detection would take place
         ...
         * @returns {object} The options for the row extended to include the options from the pages.
         */
