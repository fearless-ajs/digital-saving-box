...
h.searchPanes.panes.push({arrayFilter:j,bins:p,id:a.s.index,order:l,searchTerm:e,selected:c})}});this.s.dtPane.on("pages-select.dtsp",function(a,b,d,e,l){l.stopPropagation()});this.s.dtPane.on("draw.dtsp",function(){a._adjustTopRow()});g(this.dom.nameButton).on("click.dtsp",function(){var b=a.s.dtPane.order()[0][1];a.s.dtPane.order([0,"asc"===b?"desc":"asc"]).draw();a.s.dt.state.save()});g(this.dom.countButton).on("click.dtsp",function(){var b=a.s.dtPane.order()[0][1];a.s.dtPane.order([1,"asc"===b?
