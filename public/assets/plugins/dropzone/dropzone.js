...
var defaultOptions = {
   ...
   * This can be useful if you need some additional pages input before sending
  ...
  /**
   * If this is not null, then the pages will be prompted before removing a file.
   */
  ...
  /*
   ...
   the pages interface specific stuff. Overwriting them won't break the upload
...
var Dropzone = /*#__PURE__*/function (_Emitter) {
  ...
  dropzone_createClass(Dropzone, [{
    ...
    } // Can be called by the pages to remove a file
    ...
    value: function _uploadData(files, dataBlocks) {
      ...
      } // Let the pages add additional data if necessary
...
Dropzone.getElements = function (els, name) {
  ...
  return elements;
}; // Asks the pages the question and calls accepted or rejected accordingly
//
