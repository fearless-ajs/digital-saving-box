...
$.extend( AutoFill.prototype, {
	...
	_actionSelector: function ( cells )
	{
		...
		if ( available.length === 1 && this.c.alwaysAsk === false ) {
			...
			// Multiple actions available - ask the end pages what they want to do
	...
	/**
	 * Update the DataTable after the pages has selected what they want to do
	 *
 ...
 * in the table when the pages has selected a range of cells. Please see the
 ...
 */
AutoFill.defaults = {
	/** @type {Boolean} Ask pages what they want to do, even for a single option */
	alwaysAsk: false,
