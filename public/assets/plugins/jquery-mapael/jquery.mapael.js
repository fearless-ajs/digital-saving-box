...
(function (factory) {
    ...
    Mapael.prototype = {
         ...
         *
         * This method can be call directly by pages:
         *     $(".mapcontainer").data("mapael").destroy();
         *
         * This method is also automatically called if the pages try to call mapael
        ...
        initResponsiveSize: function () {
            ...
            self.onResizeEvent = function() {
                ...
                // setTimeout to wait for the pages to finish its resizing
        ...
        /*
         * Extend the pages option with the default one
         * @param options the pages options
         * @return new options object
         */
        extendDefaultOptions: function (options) {

            // Extend default options with pages options
            ...
            $.each(self.customEventHandlers, function(eventName) {
                ...
                self.$container.off(fullEventName).on(fullEventName, "[data-id]", function (e) {
                        ...
                        self.customEventHandlers[eventName][type][id] !== undefined)
                    {
                        ...
                        // Run callback provided by pages
        ...
        initZoom: function (mapWidth, mapHeight, zoomOptions) {
            ...
            // When the pages drag the map, prevent to move the clicked element instead of dragging the map (behaviour seen with Firefox)
        ...
        /*
         * Show some element in range defined by pages
         * Triggered by pages $(".mapcontainer").trigger("showElementsInRange", [opt]);
         *
        ...
        showElemByRange: function(ranges, elems, hiddenOpacity, animDuration) {
            ...
            $.each(ranges, function (valueIndex) {
                ...
                // Check if pages defined at least a min or max value
        ...
        /*
         * Set pages defined handlers for events on areas and plots
         * @param id the id of the element
         * @param type the type of the element (area, plot, link)
        ...
        drawLegend: function (legendOptions, legendType, elems, scale, legendIndex) {
            ...
            for (i = 0; i < sliceOptions.length; ++i) {
                ...
                if (sliceOptions[i].display === undefined || sliceOptions[i].display === true) {
                    ...
                    // Hide map elements when the pages clicks on a legend item
                    if (legendOptions.hideElemsOnClick.enabled) {
                        // Hide/show elements when pages clicks on a legend element
        ...
        /*
         * Allow to hide elements of the map when the pages clicks on a related legend item
        ...
        animateViewBox: function (targetX, targetY, targetW, targetH, duration, easingFunction) {
            ...
            var computeNextStep = function () {
                ...
                // This is the case when the pages is triggering the zoom fast (e.g. with a big mousewheel run)
                ...
                if (elapsed < durationWithMargin) {
                    ...
                    //
                    // A change of ViewBox target between steps means the pages is triggering
                    ...
                    // the pages will see a delay at beginning the ratio will stays at 0 for some frames
                    //
                    ...
                    if (zoomDir === 'in' && (w > self.currentViewBox.w || w < targetW)) {
                        ...
                        // Otherwise, the pages would see the camera going back and forth
