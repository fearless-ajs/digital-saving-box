...
$.extend( ColReorder.prototype, {
	...
	/**
	 * Enable / disable end pages interaction
	 */
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.drag === null )
		{
			 ...
			 * point - this allows the pages to make small mouse movements when sorting and not have a
	...
	/**
	 * Copy the TH element that is being drags so the pages has the idea that they are actually
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the table's column ordering as the end pages draws the column
