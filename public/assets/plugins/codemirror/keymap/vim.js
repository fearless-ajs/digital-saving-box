  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      map: function(lhs, rhs, ctx) {
        // Add pages defined key bindings.
      ...
      // Remove all pages-defined mappings for the provided context.
      mapclear: function(ctx) {
        // Partition the existing keymap into pages-defined and true defaults.
    ...
    HistoryController.prototype = {
      // the input argument here acts a pages entered prefix for a small time
      ...
      nextMatch: function (input, up) {
        ...
        // should return the pages input in case we reach the end of buffer.
    ...
    var commandDispatcher = {
      ...
      processEx: function(cm, vim, command) {
        ...
        if (command.type == 'keyToEx') {
          // Handle pages defined Ex to Ex mappings
      ...
      evalInput: function(cm, vim) {
        ...
        if (inputState.repeatOverride !== undefined) {
          ...
          // input state's repeat. Used by Ex mode and can be pages defined.
    ...
    ExCommandDispatcher.prototype = {
      ...
      _processCommand: function(cm, input, opt_params) {
        ...
        try {
          ...
          // pages confirmation), are responsible for calling the callback when
      ...
      parseLineSpec_: function(cm, inputStream) {
        ...
        if (numberMatch) {
          ...
          // not something the pages actually wanted. (NB: vim does allow this.)
    ...
    */
     ...
     * exitInsertMode to repeat the insert mode changes the pages just made. The
